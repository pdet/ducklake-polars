...
_SIMPLE_TYPE_MAP: dict[str, pl.DataType] = {
    ...
    "VARIANT": pl.String(),
    "UNKNOWN": pl.String(),
    # Per-shape geometry types (DuckLake 1.0 / spatial extension).
    # All map to WKB (binary) on read.
    "POINT": pl.Binary(),
    ...
    "POINT_Z": pl.Binary(),
    "LINESTRING_Z": pl.Binary(),
    "POLYGON_Z": pl.Binary(),
    "MULTIPOINT_Z": pl.Binary(),
    "MULTILINESTRING_Z": pl.Binary(),
    "MULTIPOLYGON_Z": pl.Binary(),
    "GEOMETRYCOLLECTION_Z": pl.Binary(),
    "POINT_M": pl.Binary(),
    "LINESTRING_M": pl.Binary(),
    "POLYGON_M": pl.Binary(),
    "MULTIPOINT_M": pl.Binary(),
    "MULTILINESTRING_M": pl.Binary(),
    "MULTIPOLYGON_M": pl.Binary(),
    "GEOMETRYCOLLECTION_M": pl.Binary(),
    "POINT_ZM": pl.Binary(),
    "LINESTRING_ZM": pl.Binary(),
    "POLYGON_ZM": pl.Binary(),
    "MULTIPOINT_ZM": pl.Binary(),
    "MULTILINESTRING_ZM": pl.Binary(),
    "MULTIPOLYGON_ZM": pl.Binary(),
    "GEOMETRYCOLLECTION_ZM": pl.Binary(),
    "WKB_BLOB": pl.Binary(),
